/**
 * Centralised configuration for the PrismUI Native mobile app surfaces in the
 * docs site. Used by:
...
export const NATIVE_APP = {
  /**
   * App Store listing for the PrismUI Native iOS app. Always defined because
  ...
  /**
   * Human-readable product name used in copy ("Open in PrismUI Native",
   * "Download PrismUI Native on the App Store", etc.). Kept here so it tracks
   ...
   */
  PLAY_STORE_URL: "https://play.google.com/store/apps/details?id=com.prismuinative.android",
  /**
   ...
   *    redirects the link into the installed PrismUI Native app.
