        ...
        linkset: [
          {
            ...
            "service-desc": [
              {
                href: absoluteUrl(origin, "/.well-known/openapi/prismui-agent-api.json"),
          ...
          },
          {
            ...
            "service-desc": [
              {
                href: absoluteUrl(origin, "/.well-known/openapi/prismui-react-mcp-api.json"),
                type: "application/vnd.oai.openapi+json",
              },
            ],
            "service-doc": [
          ...
          },
          {
            ...
            "service-desc": [
              {
                href: absoluteUrl(origin, "/.well-known/openapi/prismui-native-mcp-api.json"),
                type: "application/vnd.oai.openapi+json",
              },
            ],
            "service-doc": [
