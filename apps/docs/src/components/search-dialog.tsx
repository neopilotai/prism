...
const PRO_URL = process.env["NEXT_PUBLIC_PRO_URL"] ?? "https://prismui.pro";
...
export default function CustomSearchDialog(props: SharedProps) {
  ...
  const proResults: SearchItemType[] = useMemo(() => {
    ...
    return proComponents.map((comp) => ({
      ...
      onSelect: () =>
        window.open(
          `${PRO_URL}${comp.slug}?utm_source=prismui_docs&utm_medium=search&utm_campaign=pro_components`,
          "_blank",
        ),
