...
/**
 * Builds the official PrismUI AI setup prompt from a framework config. The prompt
...
function buildSetupPrompt({
  ...
  return `These are official instructions from PrismUI to set up a good AI development environment for building ${intro}.
 ...
 * PrismUI v3 (OSS) AI setup prompt to the clipboard.
 */
 ...
 * PrismUI Native (OSS) AI setup prompt to the clipboard.
 */
