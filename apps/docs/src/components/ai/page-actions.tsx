  ...
  const items = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        href: "cursor://anysphere.cursor-deeplink/mcp/install?name=prismui-react&config=eyJjb21tYW5kIjoibnB4IC15IEBoZXJvdWkvcmVhY3QtbWNwQGxhdGVzdCJ9",
      ...
      },
      {
        ...
        href: "vscode:mcp/install?%7B%22name%22%3A%22prismui-react%22%2C%22type%22%3A%22stdio%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22%40prismui%2Freact-mcp%40latest%22%5D%7D",
