...
const variants = [
  ...
  {
    content: [
      "https://img.prismui.chat/image/avatar?w=400&h=400&u=3",
      "https://img.prismui.chat/image/avatar?w=400&h=400&u=4",
      "https://img.prismui.chat/image/avatar?w=400&h=400&u=5",
      "https://img.prismui.chat/image/avatar?w=400&h=400&u=8",
      "https://img.prismui.chat/image/avatar?w=400&h=400&u=16",
    ],
    label: "图片",
    type: "img",
  },
