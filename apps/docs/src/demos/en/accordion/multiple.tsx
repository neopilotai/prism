  ...
  return (
    <Accordion allowsMultipleExpanded className="w-full max-w-md">
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            Learn the basics of PrismUI and how to integrate it into your React project. This section
      ...
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            Understand the fundamental concepts behind PrismUI, including the compound component
      ...
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            ...
            maintainable applications with PrismUI components.
          </Accordion.Body>
        </Accordion.Panel>
      </Accordion.Item>
    </Accordion>
