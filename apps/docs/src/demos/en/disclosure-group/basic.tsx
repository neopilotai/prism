    ...
    <div className="w-full max-w-md">
      <div className="flex flex-col gap-4 bg-transparent p-4">
        <DisclosureGroup expandedKeys={expandedKeys} onExpandedChange={setExpandedKeys}>
          <Disclosure aria-label="Preview PrismUI Native" id="preview">
            <Disclosure.Heading>
              <Button
                slot="trigger"
          ...
          <Disclosure id="download">
            <Disclosure.Heading aria-label="Download PrismUI Native">
              <Button
                slot="trigger"
            ...
            <Disclosure.Content>
              <Disclosure.Body className="mx-2 flex flex-col items-center gap-2 p-4 text-center">
                <p className="text-sm text-muted">
                  Download the PrismUI native app to explore our mobile components directly on your
                  device.
                </p>
                <img
