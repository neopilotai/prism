...
export const DESIGN_THEME_STORAGE_KEY = "prismui-docs-design-theme";
export const DESIGN_THEME_CHANGE_EVENT = "prismui-docs-design-theme-change";
export const VIBRANT_STORAGE_KEY = "prismui-docs-vibrant-palette";
