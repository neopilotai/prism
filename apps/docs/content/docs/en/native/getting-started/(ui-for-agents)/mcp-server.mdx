...
The MCP server currently supports **heroui-native** and [stdio transport](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio). Published at `@khulnasoft/native-mcp` on npm. View the source code on [GitHub](https://github.com/heroui-inc/heroui-mcp).
