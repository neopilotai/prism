---
title: Provider
description: Configure PrismUI Native provider with text, text input, animation, toast, and layout direction settings
icon: chevrons-expand-horizontal
---

The `PrismUINativeProvider` is the root provider component that configures and initializes PrismUI Native in your React Native application. It provides global configuration and portal management for your application.
