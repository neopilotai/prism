...
<NativeVideoPlayerView
  target="component"
  slug="input-otp"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/input-otp-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/input-otp-docs-dark.mp4"
/>
...
```tsx
import { InputOTP, Label, Description } from "prismui-native";
...
**Related PR:** [#214](https://github.com/khulnasoft/prismui-native/pull/214)
...
<NativeVideoPlayerView
  target="component"
  slug="label"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/label-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/label-docs-dark.mp4"
/>
...
```tsx
import { Label, TextField } from "prismui-native";
...
<NativeVideoPlayerView
  target="component"
  slug="description"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/description-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/description-docs-dark.mp4"
/>
...
**Related PR:** [#207](https://github.com/khulnasoft/prismui-native/pull/207)
...
**Related PR:** [#215](https://github.com/khulnasoft/prismui-native/pull/215)
...
**Related PR:** [#218](https://github.com/khulnasoft/prismui-native/pull/218)
...
**Related PR:** [#220](https://github.com/khulnasoft/prismui-native/pull/220)

## API Enhancements

### PrismUINativeProvider devInfo Configuration

The `PrismUINativeProvider` component now supports `devInfo` configuration options for enhanced development experience.
...
**Related PR:** [#217](https://github.com/khulnasoft/prismui-native/pull/217)
...
```tsx
import { Checkbox, Radio, TextField, InputOTP } from "prismui-native";
...
- **[Issue #93](https://github.com/khulnasoft/prismui-native/issues/93)**: Fixed global border radius configuration not applying to Button component in hero-ui-native using Unwind. The Button component now properly respects border radius settings defined in the global theme configuration, ensuring consistent styling across the application.

- **[Issue #213](https://github.com/khulnasoft/prismui-native/issues/213)**: Fixed Select controlled mode (`isOpen`) not working. The Select component now properly handles controlled state when the `isOpen` prop is provided, allowing developers to manage Select open/close state externally with predictable behavior.

**Related PRs:**

- [#218](https://github.com/khulnasoft/prismui-native/pull/218)
- [#215](https://github.com/khulnasoft/prismui-native/pull/215)
