...
<Tab value="npm">
  ```bash
  npm i prismui-native@beta
  ```
</Tab>
<Tab value="pnpm">
  ``` bash
  pnpm add prismui-native@beta
  ```
</Tab>
<Tab value="yarn">
  ```bash
  yarn add prismui-native@beta
  ```
</Tab>
<Tab value="bun">
  ```bash
  bun add prismui-native@beta
  ```
</Tab>
</Tabs>

<Callout type="info">
  **Using AI assistants?** Simply prompt "Hey Cursor, update PrismUI Native to the latest version" and your AI assistant will automatically compare versions and apply the necessary changes. Learn more about the [PrismUI Native MCP Server](/docs/native/getting-started/mcp-server).
</Callout>
...
<NativeVideoPlayerView
  target="component"
  slug="text-area"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/text-area-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/text-area-docs-dark.mp4"
/>
...
**Related PR:** [#254](https://github.com/khulnasoft/prismui-native/pull/254)
...
<NativeVideoPlayerView
  target="component"
  slug="input"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/input-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/input-docs-dark.mp4"
/>
...
**Related PR:** [#247](https://github.com/khulnasoft/prismui-native/pull/247)
...
<NativeVideoPlayerView
  target="component"
  slug="close-button"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/close-button-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/close-button-docs-dark.mp4"
/>
...
**Related PR:** [#237](https://github.com/khulnasoft/prismui-native/pull/237)
...
**Related PR:** [#228](https://github.com/khulnasoft/prismui-native/pull/228)
...
**Related PR:** [#235](https://github.com/khulnasoft/prismui-native/pull/235)
...
**Related PR:** [#227](https://github.com/khulnasoft/prismui-native/pull/227)
...
**Related PR:** [#243](https://github.com/khulnasoft/prismui-native/pull/243)
...
**Related PR:** [#248](https://github.com/khulnasoft/prismui-native/pull/248)
...
**Related PR:** [#263](https://github.com/khulnasoft/prismui-native/pull/263)
...
Granular imports are ideal when you only need a few components, as they help keep your bundle size smaller. General imports from `prismui-native` will include the entire library, which is convenient when you're using many components throughout your app.

**Available granular exports:**

- `prismui-native/provider` - Provider component
- `prismui-native/[component-name]` - Individual components
- `prismui-native/portal` - Portal utilities
- `prismui-native/utils` - Utility functions
- `prismui-native/hooks` - Custom hooks

<Callout type="warning">
  **Important**: To keep the bundle size under control, you must follow the pattern with granular imports consistently. Even one general import from `prismui-native` will break this optimization strategy.
</Callout>

**Related PR:** [#233](https://github.com/khulnasoft/prismui-native/pull/233)
...
**Related PR:** [#252](https://github.com/khulnasoft/prismui-native/pull/252)
...
**Related PR:** [#246](https://github.com/khulnasoft/prismui-native/pull/246)
...
**Related PR:** [#236](https://github.com/khulnasoft/prismui-native/pull/236)
...
```tsx
// Before
import { Divider } from "prismui-native";
...
**Related PR:** [#238](https://github.com/khulnasoft/prismui-native/pull/238)
...
```tsx
// Before
import { FormField, ErrorView, TextField } from "prismui-native";
...
// After
import { ControlField, FieldError, Input, TextField } from "prismui-native";
...
// After
import { Input, TextField } from "prismui-native";
...
```tsx
import { ControlField, Description, FieldError, Input, Label, RadioGroup, TextField } from "prismui-native";
...
- **[Issue #181](https://github.com/khulnasoft/prismui-native/issues/181)**: Fixed TextField error when inputting Chinese characters. The TextField component now properly handles multibyte characters and international input, ensuring smooth text entry for all languages including Chinese, Japanese, and Korean.

- **[Issue #219](https://github.com/khulnasoft/prismui-native/issues/219)**: Fixed Button `childrenToString()` returning `"[object Object]"` for multiple children. The function now properly handles React elements and complex children structures, preventing stringification issues when rendering button content.

- **[Issue #232](https://github.com/khulnasoft/prismui-native/issues/232)**: Fixed PrismUINativeProvider breaking with the recently released Uniwind Pro. The provider now properly handles Uniwind Pro compatibility, ensuring smooth integration with the latest Uniwind version.

- **[Issue #259](https://github.com/khulnasoft/prismui-native/issues/259)**: Fixed BottomSheet issue where opening quickly and starting a meeting would prevent it from opening again. The refactored animation system resolves this issue by improving the entering/exiting animation logic.

- **[Issue #261](https://github.com/khulnasoft/prismui-native/issues/261)**: Fixed `@gorhom/bottom-sheet` not being tree-shaken. The library now properly supports tree-shaking for unused dependencies.
...
- [#226](https://github.com/khulnasoft/prismui-native/pull/226)
- [#239](https://github.com/khulnasoft/prismui-native/pull/239)

## Links

- [Component Documentation](../components)
- [GitHub Repository](https://github.com/khulnasoft/prismui-native)
