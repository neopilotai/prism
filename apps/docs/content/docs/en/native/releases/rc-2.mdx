...
<NativeVideoPlayerView
  target="component"
  slug="slider"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/slider-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/slider-docs-dark.mp4"
/>
...
**Related PR:** [#305](https://github.com/khulnasoft/prismui-native/pull/305)
...
<NativeVideoPlayerView
  target="component"
  slug="list-group"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/list-group-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/list-group-docs-dark.mp4"
/>
...
**Related PR:** [#302](https://github.com/khulnasoft/prismui-native/pull/302)
...
<NativeVideoPlayerView
  target="component"
  slug="search-field"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/search-field-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/search-field-docs-dark.mp4"
/>
...
```tsx
import { Label, SearchField } from "prismui-native";
...
**Related PR:** [#299](https://github.com/khulnasoft/prismui-native/pull/299)
...
**Related PR:** [#298](https://github.com/khulnasoft/prismui-native/pull/298)
...
**Related PR:** [#306](https://github.com/khulnasoft/prismui-native/pull/306)
...
- **[Issue #291](https://github.com/khulnasoft/prismui-native/issues/291)**: Fixed `Select.Trigger` variant prop being overwritten by `className`. Custom class names passed to the trigger are now correctly forwarded to the style computation instead of being silently dropped.

- **[Issue #294](https://github.com/khulnasoft/prismui-native/issues/294)**: Resolved compatibility with `react-native-worklets` 0.7.x and `react-native-reanimated` 4.2.x (Expo SDK 55). Peer dependency constraints have been relaxed to accept these newer versions without producing resolution warnings.

**Related PRs:**

- [#298](https://github.com/khulnasoft/prismui-native/pull/298)
- [#306](https://github.com/khulnasoft/prismui-native/pull/306)
