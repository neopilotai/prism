...
<NativeVideoPlayerView
  target="component"
  slug="link-button"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/link-button-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/link-button-docs-dark.mp4"
/>
...
**Related PR:** [#341](https://github.com/khulnasoft/prismui-native/pull/341)
...
**Related PR:** [#343](https://github.com/khulnasoft/prismui-native/pull/343)
...
**Related PR:** [#337](https://github.com/khulnasoft/prismui-native/pull/337)
...
```tsx
import { useBottomSheetAwareHandlers, Input } from "prismui-native";
...
**Related PR:** [#347](https://github.com/khulnasoft/prismui-native/pull/347)
...
// After
import { useBottomSheetAwareHandlers } from "prismui-native";
...
- **[Issue #330](https://github.com/khulnasoft/prismui-native/issues/330)**: Resolved `Input` unconditionally importing `@gorhom/bottom-sheet` at the module level even when `isBottomSheetAware` was `false`. The package is now loaded lazily via an optional `try/catch` wrapper, so projects that don't use bottom sheet features no longer need it installed.

- **[Issue #340](https://github.com/khulnasoft/prismui-native/issues/340)**: Fixed sub-menu content appearing behind sibling sub-menu triggers. The sub-menu system now tracks the active sub-menu by ID, enforces single-open behavior, and applies correct z-index layering (`z-50` for open, `z-40` for closed).

**Related PRs:**

- [#347](https://github.com/khulnasoft/prismui-native/pull/347)
- [#343](https://github.com/khulnasoft/prismui-native/pull/343)
