...
<NativeVideoPlayerView
  target="component"
  slug="tag-group"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/tag-group-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/tag-group-docs-dark.mp4"
/>
...
**Related PR:** [#309](https://github.com/khulnasoft/prismui-native/pull/309)
...
<NativeVideoPlayerView
  target="component"
  slug="menu"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/menu-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/menu-docs-dark.mp4"
/>
...
```tsx
import { Menu } from "prismui-native";
...
**Related PR:** [#312](https://github.com/khulnasoft/prismui-native/pull/312)
...
<NativeVideoPlayerView
  target="component"
  slug="input-group"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/input-group-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/input-group-docs-dark.mp4"
/>
...
**Related PR:** [#313](https://github.com/khulnasoft/prismui-native/pull/313)
...
**Related PR:** [#308](https://github.com/khulnasoft/prismui-native/pull/308)
...
**Related PR:** [#314](https://github.com/khulnasoft/prismui-native/pull/314)
...
- **[Issue #272](https://github.com/khulnasoft/prismui-native/issues/272)**: Resolved `FullWindowOverlay` interfering with the React Native element inspector.

- **[Issue #280](https://github.com/khulnasoft/prismui-native/issues/280)**: Fixed Avatar component and other Reanimated-dependent components breaking under Expo 55. The `combineStyles` function was destroying Reanimated animated style bindings via `StyleSheet.flatten`; it now returns style arrays to preserve `SharedValue` and `useAnimatedStyle` bindings.

**Related PRs:**

- [#308](https://github.com/khulnasoft/prismui-native/pull/308)
- [#314](https://github.com/khulnasoft/prismui-native/pull/314)
