...
**Related PR:** [#438](https://github.com/khulnasoft/prismui-native/pull/438)
...
**Related PR:** [#435](https://github.com/khulnasoft/prismui-native/pull/435)
...
**Related PR:** [#436](https://github.com/khulnasoft/prismui-native/pull/436)

## API Enhancements

### Provider Text Input Configuration

The [PrismUINativeProvider](/docs/native/getting-started/provider) (and `PrismUINativeProviderRaw`) can now configure a subset of `TextInput` props globally through a new `textInputProps` config, starting with `allowFontScaling` and `maxFontSizeMultiplier`. This mirrors the existing global `textProps` pattern and keeps input font-scaling behavior consistent across the app.
...
- New `textInputProps` config on `PrismUINativeConfig` and `PrismUINativeConfigRaw` (`allowFontScaling`, `maxFontSizeMultiplier`)
...
**Related PR:** [#437](https://github.com/khulnasoft/prismui-native/pull/437)
...
**Related PR:** [#439](https://github.com/khulnasoft/prismui-native/pull/439)
...
**Related PR:** [#434](https://github.com/khulnasoft/prismui-native/pull/434)
