...
```tsx
import { AlertDialog } from "@khulnasoft/react";
```
...
The AlertDialog component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/alert-dialog.css)):
