...
```tsx
import { ListBox } from '@khulnasoft/react';
```
...
```tsx
import { ListBox, Label, Description, Header } from '@khulnasoft/react';
...
The ListBox component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/list-box.css)):
...
```tsx
import { ListBox, Label, Description } from '@khulnasoft/react';
...
<ListBox aria-label="Users" selectionMode="single">
  ...
  <ListBox.Item id="2" textValue="Alice">
    <Label>Alice</Label>
    <Description>alice@khulnasoft.com</Description>
  </ListBox.Item>
</ListBox>
```
...
```tsx
import { ListBox, Header, Separator } from '@khulnasoft/react';
...
```tsx
import { ListBox, Selection } from '@khulnasoft/react';
...
```tsx
import { ListBox, ListBoxItemIndicator } from '@khulnasoft/react';
