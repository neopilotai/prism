...
```tsx
import { Dropdown } from '@khulnasoft/react';
```
...
```tsx
import { Dropdown, Button, Label, Description, Header, Kbd, Separator } from '@khulnasoft/react';
...
The Dropdown component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/dropdown.css)):
...
#### Menu Classes [!toc]
- `.menu` - Base menu container ([menu.css](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/menu.css))
  - `[data-slot="separator"]` - Separator elements within the menu

#### MenuItem Classes [!toc]
- `.menu-item` - Base menu item container ([menu-item.css](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/menu-item.css))
...
- `.menu-section` - Base menu section container ([menu-section.css](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/menu-section.css))
...
```tsx
import { Dropdown, Button, Label } from '@khulnasoft/react';
...
```tsx
import { Dropdown, Button, Label, Header, Separator } from '@khulnasoft/react';
