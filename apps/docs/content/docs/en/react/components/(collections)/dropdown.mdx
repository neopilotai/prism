...
The Dropdown component uses these CSS classes ([View source styles](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/components/dropdown.css)):
...
#### Menu Classes [!toc]
- `.menu` - Base menu container ([menu.css](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/components/menu.css))
  - `[data-slot="separator"]` - Separator elements within the menu

#### MenuItem Classes [!toc]
- `.menu-item` - Base menu item container ([menu-item.css](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/components/menu-item.css))
...
- `.menu-section` - Base menu section container ([menu-section.css](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/components/menu-section.css))
