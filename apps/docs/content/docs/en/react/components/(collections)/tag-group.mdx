...
```tsx
import { TagGroup } from '@khulnasoft/react';
```
...
```tsx
import { TagGroup, Tag, Label, Description, ErrorMessage } from '@khulnasoft/react';
...
The TagGroup component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/tag-group.css) and [tag.css](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/tag.css)):
