...
```tsx
import { ColorField, parseColor } from '@prismui/react';
```
...
```tsx
import {ColorField, Label, ColorSwatch, Description, FieldError, parseColor} from '@prismui/react';
...
- **Label** - Field label component from `@prismui/react`
...
- **ColorSwatch** - Color preview component from `@prismui/react`
- **Description** - Helper text component from `@prismui/react`
- **FieldError** - Validation error message from `@prismui/react`
...
```tsx
import {parseColor} from '@prismui/react';
