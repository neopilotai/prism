...
```tsx
import { ColorPicker, ColorArea, ColorSlider, ColorSwatch, Label } from '@khulnasoft/react';
...
The ColorPicker component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/color-picker.css)):
