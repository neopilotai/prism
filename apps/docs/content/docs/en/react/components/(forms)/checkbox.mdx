...
```tsx
import { Checkbox, Description, FieldError } from '@khulnasoft/react';
...
The Checkbox component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/checkbox.css)):
