...
The CheckboxGroup component uses these CSS classes ([View source styles](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/components/checkbox-group.css)):
