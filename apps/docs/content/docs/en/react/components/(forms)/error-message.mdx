...
```tsx
import { ErrorMessage } from '@khulnasoft/react';
```
...
The ErrorMessage component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/error-message.css)):
