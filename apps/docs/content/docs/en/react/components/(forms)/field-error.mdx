...
```tsx
import { FieldError } from '@khulnasoft/react';
```
...
The FieldError component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/field-error.css)):
