...
```tsx
import { Badge } from '@khulnasoft/react';
```
...
The Badge component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/badge.css)):
