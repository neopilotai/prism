...
```tsx
import { Autocomplete, useFilter } from "@khulnasoft/react";
```
...
```tsx
import {Autocomplete, Label, Description, SearchField, ListBox} from "@khulnasoft/react";
...
The Autocomplete component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/autocomplete.css)):
