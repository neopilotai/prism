...
```tsx
import { Switch, SwitchGroup, Label } from '@khulnasoft/react';
```
...
The Switch component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/switch.css)):
...
The SwitchGroup component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/switch-group.css)):
