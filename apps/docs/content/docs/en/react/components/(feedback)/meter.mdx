...
```tsx
import { Meter, Label } from '@khulnasoft/react';
```
...
The Meter component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/meter.css)):
