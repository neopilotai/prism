...
The Link component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/link.css)):
...
Since PrismUI uses [BEM](https://getbem.com/) classes, you can apply Link styles directly to any link element:
