...
```tsx
import { DisclosureGroup } from '@khulnasoft/react';
```
...
```tsx
import {DisclosureGroup, Disclosure} from '@khulnasoft/react';
...
The DisclosureGroup component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/disclosure-group.css)):
