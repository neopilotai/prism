...
The ToggleButtonGroup component uses these CSS classes ([View source styles](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/components/toggle-button-group.css)):
