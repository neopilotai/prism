...
The Surface component uses these CSS classes ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/surface.css)):
...
import { SurfaceContext } from '@khulnasoft/react';
