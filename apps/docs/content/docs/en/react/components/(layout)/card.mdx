...
Card uses [BEM](https://getbem.com/) naming for predictable styling ([View source styles](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/card.css)):
