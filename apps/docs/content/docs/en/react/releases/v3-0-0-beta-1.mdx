...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @khulnasoft/styles@beta @prismui/react@beta
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @khulnasoft/styles@beta @prismui/react@beta
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @khulnasoft/styles@beta @prismui/react@beta
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @khulnasoft/styles@beta @prismui/react@beta
    ```
  </Tab>
</Tabs>
...
// 3. Named exports
import { AvatarRoot, AvatarImage, AvatarFallback } from "@prismui/react"
...
```tsx
import { Avatar, AvatarFallback } from "@prismui/react"
...
```tsx
import type { AvatarRootProps } from "@prismui/react"
