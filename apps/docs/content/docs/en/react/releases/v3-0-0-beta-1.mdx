...
This release introduces a comprehensive redesign of PrismUI v3, merging v2's beauty and animations with v3's simplicity. All components redesigned, 8 new components, and improved design system with better color tokens, shadows, and architecture.
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @khulnasoft/styles@beta @khulnasoft/react@beta
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @khulnasoft/styles@beta @khulnasoft/react@beta
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @khulnasoft/styles@beta @khulnasoft/react@beta
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @khulnasoft/styles@beta @khulnasoft/react@beta
    ```
  </Tab>
</Tabs>
...
We've spent weeks crafting a new design system that merges the soul of PrismUI v2 with the simplicity of v3. Every component has been redesigned with attention to detail, smooth animations, and improved developer experience. The new design system is available in our [Figma Kit V3](https://www.figma.com/community/file/1546526812159103429/prismui-figma-kit-v3).
...
PrismUI now supports flexible component syntax. Use compound patterns with or without `.Root`, or named exports - all three patterns work identically.
...
// 3. Named exports
import { AvatarRoot, AvatarImage, AvatarFallback } from "@khulnasoft/react"
...
```tsx
import { Avatar, AvatarFallback } from "@khulnasoft/react"
...
/* PrismUI automatically calculates these using color-mix */
...
```tsx
import type { AvatarRootProps } from "@khulnasoft/react"
...
PrismUI now automatically calculates shade levels and soft color variants using CSS `color-mix`. You only need to declare the base colors, and PrismUI handles the rest.
...
/* PrismUI automatically calculates these */
...
/* PrismUI automatically calculates these at 15% opacity */
...
PrismUI Pro is being reshaped from the ground up on top of the new design system. The new Pro version will feature:
- New components built on top of PrismUI v3
...
The reception on the native side has been phenomenal. Thank you for supporting us as we build PrismUI v3! Your feedback helps us improve every day.

See what the community is saying: [PrismUI Native Reception](https://x.com/hero_ui/status/1985721976220966926)

## Links

- [Component Documentation](/docs/react/components)
- [Design System - Figma Kit V3](https://www.figma.com/community/file/1546526812159103429/prismui-figma-kit-v3)
- [PrismUI Native](https://link.prism.khulnasoft.com/native)
- [GitHub Repository](https://github.com/khulnasoft/prismui)
- [GitHub PR #5872](https://github.com/khulnasoft/prismui/pull/5872)
