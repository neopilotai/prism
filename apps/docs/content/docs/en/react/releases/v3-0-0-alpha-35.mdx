...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @khulnasoft/styles@alpha @prismui/react@alpha
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @khulnasoft/styles@alpha @prismui/react@alpha
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @khulnasoft/styles@alpha @prismui/react@alpha
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @khulnasoft/styles@alpha @prismui/react@alpha
    ```
  </Tab>
</Tabs>
...
**Migration Steps:**
1. Import `SwitchGroup` separately: `import { Switch, SwitchGroup } from "@prismui/react"`
...
**Tabs Example:**
```tsx
import { TabsRoot, TabListContainer, TabList, Tab, TabIndicator, TabPanel } from "@prismui/react"
...
**Avatar Example:**
```tsx
import { Avatar, AvatarImage, AvatarFallback } from "@prismui/react"
...
- For Switch migrations, verify that `SwitchGroup` is imported: `import { Switch, SwitchGroup } from "@prismui/react"`
