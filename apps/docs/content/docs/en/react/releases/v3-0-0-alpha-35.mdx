...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @khulnasoft/styles@alpha @khulnasoft/react@alpha
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @khulnasoft/styles@alpha @khulnasoft/react@alpha
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @khulnasoft/styles@alpha @khulnasoft/react@alpha
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @khulnasoft/styles@alpha @khulnasoft/react@alpha
    ```
  </Tab>
</Tabs>
...
**Migration Steps:**
1. Import `SwitchGroup` separately: `import { Switch, SwitchGroup } from "@khulnasoft/react"`
...
You have two options for using PrismUI compound components:
...
**Tabs Example:**
```tsx
import { TabsRoot, TabListContainer, TabList, Tab, TabIndicator, TabPanel } from "@khulnasoft/react"
...
**Avatar Example:**
```tsx
import { Avatar, AvatarImage, AvatarFallback } from "@khulnasoft/react"
...
- For Switch migrations, verify that `SwitchGroup` is imported: `import { Switch, SwitchGroup } from "@khulnasoft/react"`
...
4. Report issues at: [GitHub Issues](https://github.com/khulnasoft/prismui/issues)
