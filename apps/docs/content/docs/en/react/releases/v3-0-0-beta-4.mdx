...
We're excited to introduce the **[Theme Builder](/themes)** - a powerful visual tool for creating and customizing PrismUI themes. Build your perfect theme with real-time preview and export ready-to-use CSS.
...
Try it now at [v3.prism.khulnasoft.com/themes](/themes).
...
PrismUI now provides direct exports from react-aria-components for easier access to primitives and utilities. These exports are particularly useful for [React Aria Framework setup](https://react-aria.adobe.com/frameworks).
...
All of these can be imported directly from `@khulnasoft/react`:
...
- [Design System - Figma Kit V3 (updated)](https://www.figma.com/community/file/1546526812159103429/prismui-figma-kit-v3)
- [GitHub Repository](https://github.com/khulnasoft/prismui)
- [GitHub PR #6121](https://github.com/khulnasoft/prismui/pull/6121)
