...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @khulnasoft/styles@rc @prismui/react@rc
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @khulnasoft/styles@rc @prismui/react@rc
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @khulnasoft/styles@rc @prismui/react@rc
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @khulnasoft/styles@rc @prismui/react@rc
    ```
  </Tab>
</Tabs>
...
Table and ListBox now support virtualization via React Aria's `Virtualizer` for large datasets. `Virtualizer`, `TableLayout`, and `ListLayout` are re-exported from `@prismui/react`.
...
`@prismui/react` now supports per-component subpath entrypoints for more explicit imports ([#6301](https://github.com/khulnasoft/prismui/pull/6301)):
