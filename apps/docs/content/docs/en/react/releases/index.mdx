---
title: All Releases
description: All updates and changes to PrismUI v3, including new features, fixes, and breaking changes.
---
...
Patch release: `@khulnasoft/react` no longer bundles its own copy of `react-aria`. The `react-aria` subpaths are externalized in the Rollup build, so consumers resolve to the single `react-aria` installed in their project instead of a vendored copy. Also fixes `SwitchGroup` horizontal layout.
...
Patch release: new `Text` compound component ported from PrismUI Pro, docs theme selector, `min()`-capped border-radius tokens across 45+ component CSS files, reworked Table focus rings, and fixes for Checkbox, Autocomplete, Tooltip, and form field padding.

<VideoPlayer
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/videos/prismui-oss-3.0.4-4k.mp4"
  muted
/>
...
<DocsImage
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/rc-1-light@2x.jpg"
  darkSrc="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/rc-1-dark@2x.jpg"
  alt="PrismUI v3 RC 1"
...
<DocsImage
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-8-light@2x.jpg"
  darkSrc="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-8-dark@2x.jpg"
  alt="PrismUI v3 Beta 8"
...
<DocsImage
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-7-light@2x.jpg"
  darkSrc="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-7-dark@2x.jpg"
  alt="PrismUI v3 Beta 7"
...
<DocsImage
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-6-light@2x.jpg"
  darkSrc="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-6-dark@2x.jpg"
  alt="PrismUI v3 Beta 6"
...
<DocsImage
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-4-light@2x.jpg"
  darkSrc="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-4-dark@2x.jpg"
  alt="PrismUI v3 Beta 4"
  href="/docs/react/releases/v3-0-0-beta-4"
/>

<Callout type="warning">
  **Critical Build Issue Fixed**: This version (beta.4) had a critical build issue that has been fixed in **beta.5**. Please upgrade to `@khulnasoft/styles@3.0.0-beta.5` and `@khulnasoft/react@3.0.0-beta.5` to ensure proper TypeScript declaration generation and export resolution.
</Callout>
...
<DocsImage
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-3-light@2x.jpg"
  darkSrc="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-3-dark@2x.jpg"
  alt="PrismUI v3 Beta 3"
...
<DocsImage
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-2-light@2x.jpg"
  darkSrc="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/versions/beta-2-dark@2x.jpg"
  alt="PrismUI v3 Beta 2"
...
- 🎨 **Showcases page** - Gallery of sites built with PrismUI
...
PrismUI v3 is now stable. Future releases follow a regular cycle:
...
Found an issue or want to contribute? Check out our [GitHub repository](https://github.com/khulnasoft/prismui).
