...
**Before:**
```tsx
import { Switch, Label, Description } from '@prismui/react';
...
`DateInputGroup` and `ColorInputGroup` are no longer exported directly from `@prismui/react`. Their sub-components have been consolidated under their respective field components (`DateField`, `TimeField`, `ColorField`).

#### DateField Changes

**Before:**
```tsx
import {DateField, Label, DateInputGroup, Description} from '@prismui/react';
...
**After:**
```tsx
import {DateField, Label, Description} from '@prismui/react';
...
```tsx
import {ColorField, Label, ColorInputGroup, ColorSwatch} from '@prismui/react';
...
**After:**
```tsx
import {ColorField, Label, ColorSwatch} from '@prismui/react';
