...
```tsx
// Before
import type { SelectContentProps } from "@khulnasoft/react"

// After
import type { SelectPopoverProps } from "@khulnasoft/react"
```
...
```tsx
// Before
import { SelectContent } from "@khulnasoft/react"

// After
import { SelectPopover } from "@khulnasoft/react"
```
...
- [GitHub PR #5885](https://github.com/khulnasoft/prismui/pull/5885)
