...
```tsx
// Before
import type { SelectContentProps } from "@prismui/react"

// After
import type { SelectPopoverProps } from "@prismui/react"
```
...
```tsx
// Before
import { SelectContent } from "@prismui/react"

// After
import { SelectPopover } from "@prismui/react"
```
