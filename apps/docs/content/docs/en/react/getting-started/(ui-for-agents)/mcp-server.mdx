...
The MCP server currently supports **@khulnasoft/react v3** only and [stdio transport](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio). Published at `@khulnasoft/react-mcp` on npm. View the source code on [GitHub](https://github.com/khulnasoft/heroui-mcp).
...
```bash
claude mcp add heroui-react -- npx -y @khulnasoft/react-mcp@latest
```
