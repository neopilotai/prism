---
title: LLMs.txt
description: Enable AI assistants like Claude, Cursor, and Windsurf to understand PrismUI v3
---

We provide [LLMs.txt](https://llmstxt.org/) files to make PrismUI v3 documentation accessible to AI coding assistants.

## Available Files

**Core documentation:**
- [/react/llms.txt](/react/llms.txt) — Quick reference index for React documentation
- [/react/llms-full.txt](/react/llms-full.txt) — Complete PrismUI React documentation
...
```
Use PrismUI React documentation from https://prism.khulnasoft.com/react/llms.txt
```
Or add to your project's `.claude` file for automatic loading.

**Cursor:** Use the `@Docs` feature:
```
@Docs https://prism.khulnasoft.com/react/llms-full.txt
```
...
```
https://prism.khulnasoft.com/react/llms.txt
```

**For component-specific documentation:**
```
https://prism.khulnasoft.com/react/llms-components.txt
```

**For patterns and best practices:**
```
https://prism.khulnasoft.com/react/llms-patterns.txt
```
