...
PrismUI defines three types of variables in [`variables.css`](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/themes/default/variables.css):
...
For a complete reference, see: [Colors Documentation](/docs/handbook/colors), [Default Theme Variables](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/themes/default/variables.css), [Shared Theme Utilities](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/themes/shared/theme.css)

**Tailwind theme bridge (`@theme inline`):**

[`themes/shared/theme.css`](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/themes/shared/theme.css) maps semantic variables to Tailwind tokens (`--color-*`, `--radius-*`, `--ease-*`). Calculated colors reference underlying vars (e.g. `--surface-hover`, `--accent-soft`) from `variables.css` — they are not inlined with `color-mix()` in this file:
...
**Theme variables** — defined in light and dark theme blocks in [`variables.css`](https://github.com/khulnasoft/heroui/blob/v3/packages/styles/themes/default/variables.css):
