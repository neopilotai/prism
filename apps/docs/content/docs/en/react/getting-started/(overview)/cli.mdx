...
Commands:
  ...
  install [options]              Installs @prismui/react and @khulnasoft/styles to your project
  upgrade [options]              Upgrades @prismui/react and @khulnasoft/styles to the latest versions
  uninstall [options]            Uninstall @prismui/react and @khulnasoft/styles from the project
  list [options]                 Lists installed PrismUI packages (@prismui/react, @khulnasoft/styles)
...
Install `@prismui/react` and `@khulnasoft/styles` to your project, along with their peer dependencies. If they are already installed, the command does nothing.
...
✅ @prismui/react and @khulnasoft/styles installed successfully
```

### upgrade


Upgrade `@prismui/react` and `@khulnasoft/styles` with their peer dependencies to the latest versions.
...
Uninstall `@prismui/react` and `@khulnasoft/styles` from your project. Peer dependencies will not be uninstalled.
...
✅ Successfully uninstalled: @prismui/react, @khulnasoft/styles
```

### list

List the installed PrismUI packages (`@prismui/react`, `@khulnasoft/styles`).
...
- Check whether `@prismui/react` and `@khulnasoft/styles` are installed
