...
To install `/cli` globally, execute one of the following commands in your terminal:


```npm
npm install /cli@latest -g
```

### Without Installation

Alternatively, you can use `/cli` without a global installation by running one of the following:
...
Once `/cli` is installed, run the following command to display available commands:
...
If you found a bug, please report it in [/cli Issues](https://github.com/khulnasoft/prism/issues).
