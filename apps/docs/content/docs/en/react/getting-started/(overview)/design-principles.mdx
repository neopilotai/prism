...
description: Core principles that guide PrismUI v3's design and development
icon: book
---

PrismUI v3 follows 10 core principles that prioritize clarity, accessibility, customization, and developer experience.
...
<DocsImage
  src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/emphasis.jpg"
  darkSrc="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/emphasis-dark.jpg"
...
```tsx
import { Tabs, TabList, Tab, TabPanel } from '@khulnasoft/react';
...
import { Alert, AlertIcon, CardHeader, AccordionTrigger } from '@khulnasoft/react';
...
Styles (`@khulnasoft/styles`) are separate from logic (`@khulnasoft/react`), enabling use with any framework or vanilla HTML. See [Tailwind Play example](https://play.tailwindcss.com/vMYXzKPyUx).
...
// Apply PrismUI's BEM classes directly to any element
...
## Comparison with PrismUI v2

| Aspect | PrismUI v2 | PrismUI v3 |
|--------|-----------|-----------|
