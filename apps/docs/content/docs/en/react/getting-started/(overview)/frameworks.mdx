---
title: Frameworks
description: Integrate PrismUI with your framework
icon: layers
---
...
### 2. Use your first PrismUI component
    ...
    export default function HomePage() {
      return (
        <main className="flex min-h-screen items-center justify-center">
          <Button variant="tertiary">Hello PrismUI</Button>
        </main>
      );
    }
    ```
...
<Callout>
  PrismUI v3 does not require a provider. Components work directly after installation and style import.
</Callout>
...
import {isRTL} from '@khulnasoft/react';
...
import {I18nProvider} from '@khulnasoft/react';
