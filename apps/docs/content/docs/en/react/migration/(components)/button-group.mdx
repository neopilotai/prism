---
title: ButtonGroup
description: Migration guide for ButtonGroup from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 ButtonGroup documentation](/docs/react/components/button-group) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { ButtonGroup, Button } from "@khulnasoft/react";
...
**v2:** Imported from `@khulnasoft/react`  
**v3:** Imported from `@khulnasoft/react` (same package, but unified import)
