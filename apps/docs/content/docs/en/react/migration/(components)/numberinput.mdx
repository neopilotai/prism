---
title: NumberInput
description: Migration guide for NumberInput to NumberField from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 NumberField documentation](/docs/react/components/numberfield) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { NumberInput } from "@khulnasoft/react";
...
```tsx
import { NumberField, Label } from "@khulnasoft/react";
