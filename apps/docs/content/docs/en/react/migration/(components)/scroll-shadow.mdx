...
**v3:** Imported from `@prismui/react` unified package
...
- Update import from `@khulnasoft/scroll-shadow` to `@prismui/react`
- Enhanced API with more configuration options
- Better shadow detection and visibility control
- Same orientation support (vertical / horizontal); import from `@prismui/react`
