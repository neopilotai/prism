---
title: Spacer
description: Migration guide for Spacer from PrismUI v2 to v3
---

<Callout type="warning">
  The Spacer component has been **removed** in PrismUI v3. Use Tailwind CSS margin utilities directly instead.
</Callout>
...
**v2:** `<Spacer>` component from `@khulnasoft/react`  
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer } from "@khulnasoft/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer, Button } from "@khulnasoft/react";
...
2. **Import Change**: Remove `import { Spacer } from "@khulnasoft/react"`
...
1. **Remove Import**: Remove `Spacer` from `@khulnasoft/react` imports
