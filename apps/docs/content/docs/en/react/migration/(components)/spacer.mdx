...
**v2:** `<Spacer>` component from `@prismui/react`  
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer } from "@prismui/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer, Button } from "@prismui/react";
...
2. **Import Change**: Remove `import { Spacer } from "@prismui/react"`
...
1. **Remove Import**: Remove `Spacer` from `@prismui/react` imports
