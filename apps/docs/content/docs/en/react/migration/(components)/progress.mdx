---
title: Progress
description: Migration guide for Progress from PrismUI v2 to v3 (now ProgressBar)
---

<Callout type="info">
  Refer to the [v3 ProgressBar documentation](/docs/react/components/progress-bar) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { Progress } from "@khulnasoft/react";
...
```tsx
import { ProgressBar, Label } from "@khulnasoft/react";
