---
title: TimeInput
description: Migration guide for TimeInput to TimeField from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 TimeField documentation](/docs/react/components/time-field) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { TimeInput } from "@khulnasoft/react";
...
```tsx
import { TimeField, DateInputGroup, Label } from "@khulnasoft/react";
