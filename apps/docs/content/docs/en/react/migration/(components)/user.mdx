---
title: User
description: Migration guide for User from PrismUI v2 to v3
---

<Callout type="warning">
  The User component has been **removed** in PrismUI v3. Compose user displays manually using Avatar and text elements with Tailwind CSS classes.
</Callout>
...
**v2:** `<User>` component from `@khulnasoft/react`  
...
```tsx
import { User } from "@khulnasoft/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { User, Link } from "@khulnasoft/react";
...
2. **Import Change**: Remove `import { User } from "@khulnasoft/react"`
...
1. **Remove Import**: Remove `User` from `@khulnasoft/react` imports
