---
title: Input
description: Migration guide for Input from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Input documentation](/docs/react/components/input) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { TextField, Label, Input, FieldError } from "@khulnasoft/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { InputGroup } from "@khulnasoft/react";
