...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Navbar, NavbarBrand, NavbarContent, NavbarItem, Link, Button } from "@prismui/react";
  ...
  <Tab value="v3">
    ```tsx
    import { Link, Button } from "@prismui/react";
...
2. **Import Change**: Remove all Navbar imports from `@prismui/react`
