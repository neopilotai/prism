---
title: Calendar
description: Migration guide for Calendar from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Calendar documentation](/docs/react/components/calendar) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
