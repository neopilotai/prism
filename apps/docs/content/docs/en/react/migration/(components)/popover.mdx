---
title: Popover
description: Migration guide for Popover from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Popover documentation](/docs/react/components/popover) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { Popover, PopoverTrigger, PopoverContent, Button } from "@khulnasoft/react";
...
```tsx
import { Popover, Button } from "@khulnasoft/react";
