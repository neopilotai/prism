---
title: Link
description: Migration guide for Link from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Link documentation](/docs/react/components/link) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
