---
title: Badge
description: Migration guide for Badge from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Badge documentation](/docs/react/components/badge) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { Badge, Avatar } from "@khulnasoft/react";
