---
title: Slider
description: Migration guide for Slider from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Slider documentation](/docs/react/components/slider) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
