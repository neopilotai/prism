...
```tsx
import { Select, SelectItem } from "@prismui/react";
...
```tsx
import { Select, Label, ListBox } from "@prismui/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Label, Description, FieldError } from "@prismui/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Select, SelectItem, SelectSection } from "@prismui/react";
  ...
  <Tab value="v3">
    ```tsx
    import { Select, Label, ListBox, Header, Separator } from "@prismui/react";
