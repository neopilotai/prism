---
title: Select
description: Migration guide for Select from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Select documentation](/docs/react/components/select) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { Select, SelectItem } from "@khulnasoft/react";
...
```tsx
import { Select, Label, ListBox } from "@khulnasoft/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Label, Description, FieldError } from "@khulnasoft/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Select, SelectItem, SelectSection } from "@khulnasoft/react";
  ...
  <Tab value="v3">
    ```tsx
    import { Select, Label, ListBox, Header, Separator } from "@khulnasoft/react";
