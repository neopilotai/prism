---
title: Image
description: Migration guide for Image from PrismUI v2 to v3
---

<Callout type="warning">
  The Image component has been **removed** in PrismUI v3. Use native HTML `<img>` element or Next.js `Image` component with Tailwind CSS classes instead.
</Callout>
...
**v2:** `<Image>` component from `@khulnasoft/react`  
...
```tsx
import { Image } from "@khulnasoft/react";
...
2. **Import Change**: Remove `import { Image } from "@khulnasoft/react"`
...
1. **Remove Import**: Remove `Image` from `@khulnasoft/react` imports
