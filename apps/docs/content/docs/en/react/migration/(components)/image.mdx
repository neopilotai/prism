...
**v2:** `<Image>` component from `@prismui/react`  
...
```tsx
import { Image } from "@prismui/react";
...
2. **Import Change**: Remove `import { Image } from "@prismui/react"`
...
1. **Remove Import**: Remove `Image` from `@prismui/react` imports
