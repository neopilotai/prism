---
title: Dropdown
description: Migration guide for Dropdown from PrismUI v2 to v3
---

<Callout type="info">
  Refer to the [v3 Dropdown documentation](/docs/react/components/dropdown) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from PrismUI v2.
</Callout>
...
```tsx
import { Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Button } from "@khulnasoft/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ...
    import { Label, Description, Kbd } from "@khulnasoft/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Label, Kbd } from "@khulnasoft/react";
