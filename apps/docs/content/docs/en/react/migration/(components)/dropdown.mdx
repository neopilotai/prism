...
```tsx
import { Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Button } from "@prismui/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ...
    import { Label, Description, Kbd } from "@prismui/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Label, Kbd } from "@prismui/react";
