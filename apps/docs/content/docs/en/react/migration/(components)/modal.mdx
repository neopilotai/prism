...
<Tabs items={["v2", "v3 (Button trigger)", "v3 (Modal.Trigger)"]}>
  <Tab value="v2">
    ```tsx
    import { Modal, ModalContent, Button, useDisclosure } from "@prismui/react";
  ...
  <Tab value="v3 (Modal.Trigger)">
    ```tsx
    import { Modal } from "@prismui/react";
...
```tsx
import { useOverlayState } from "@prismui/react";
...
<Tabs items={["v2", "v3 (useState)", "v3 (useOverlayState)", "v3 (state prop)"]}>
  <Tab value="v2">
    ```tsx
    import { useDisclosure } from "@prismui/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Modal, ModalContent, useDisclosure } from "@prismui/react";
