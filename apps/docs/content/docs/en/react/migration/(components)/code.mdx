---
title: Code
description: Migration guide for Code from PrismUI v2 to v3
---

<Callout type="warning">
  The Code component has been **removed** in PrismUI v3. Use native HTML `<code>` element with Tailwind CSS classes instead.
</Callout>
...
**v2:** `<Code>` component from `@khulnasoft/react`  
...
```tsx
import { Code } from "@khulnasoft/react";

export default function App() {
  return <Code>npm install @khulnasoft/react</Code>;
}
```
    ...
    export default function App() {
      return (
        <div className="space-y-4">
          <p>
            Install PrismUI with <Code>npm install @khulnasoft/react</Code>
          </p>
...
2. **Import Change**: Remove `import { Code } from "@khulnasoft/react"`
...
1. **Remove Import**: Remove `Code` from `@khulnasoft/react` imports
