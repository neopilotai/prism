...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm uninstall @prismui/react @khulnasoft/theme
    npm install @khulnasoft/styles @prismui/react
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm remove @prismui/react @khulnasoft/theme
    pnpm add @khulnasoft/styles @prismui/react
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn remove @prismui/react @khulnasoft/theme
    yarn add @khulnasoft/styles @prismui/react
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun remove @prismui/react @khulnasoft/theme
...
```js
// tailwind.config.js
const {prismui} = require("@prismui/react");
...
import {Button, type ButtonProps} from "@prismui/react";

// Compound component types are properly exported
import {Checkbox, type CheckboxProps} from "@prismui/react";
...
- Update all component imports to `@prismui/react`
