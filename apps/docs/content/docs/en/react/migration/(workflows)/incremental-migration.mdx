...
```json
{
  "dependencies": {
    ...
    "@heroui-v3/react": "npm:@khulnasoft/react@latest",
    "@heroui-v3/styles": "npm:@khulnasoft/styles@latest"
  }
}
```
...
2. **Update imports**
   - Strategy A: Change `@khulnasoft/react` → `@heroui-v3/react`
...
2. **Update all imports:**
   - Change `@heroui-v3/react` → `@khulnasoft/react` (Strategy A)
