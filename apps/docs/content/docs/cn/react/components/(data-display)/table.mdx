...
PrismUI 的 Table 作为无头表格库之上的渲染层。
本示例使用 [TanStack Table](https://tanstack.com/table) 处理列定义、排序与分页，而 PrismUI 负责样式与无障碍。
...
Table 组件使用以下 CSS 类（[查看源码样式](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/table.css)）：
