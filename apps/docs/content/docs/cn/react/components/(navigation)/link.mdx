...
Link 使用以下 CSS 类（[查看源码样式](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/link.css)）：
...
由于 PrismUI 使用 [BEM](https://getbem.com/) 类，你可以将 Link 样式直接应用到任意链接元素：
