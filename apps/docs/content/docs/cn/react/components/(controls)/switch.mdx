...
Switch 组件使用以下 CSS 类（[查看源码样式](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/switch.css)）：
...
SwitchGroup 组件使用以下 CSS 类（[查看源码样式](https://github.com/khulnasoft/prismui/blob/v3/packages/styles/components/switch-group.css)）：
