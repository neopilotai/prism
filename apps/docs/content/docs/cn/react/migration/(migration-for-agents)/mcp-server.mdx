...
迁移 MCP 服务器使用 **Streamable HTTP 传输**（基于 URL）并部署在`https://migration-mcp.prism.khulnasoft.com`。查看源代码[GitHub](https://github.com/khulnasoft/heroui-mcp/tree/main/apps/migration-mcp).
...
- [GitHub 存储库](https://github.com/khulnasoft/heroui-mcp/tree/main/apps/migration-mcp)
