...
MCP 服务器目前仅支持 **@khulnasoft/react v3**，并使用 [stdio 传输](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio)。已在 npm 上以 `@khulnasoft/react-mcp` 发布。源代码请查看 [GitHub](https://github.com/khulnasoft/heroui-mcp)。
...
**需要帮助？** [GitHub Issues](https://github.com/khulnasoft/heroui-mcp/issues) | [Discord 社区](https://discord.gg/heroui)

## 链接

- [npm 包](https://www.npmjs.com/package/@khulnasoft/react-mcp)
- [GitHub 仓库](https://github.com/khulnasoft/heroui-mcp)
- [贡献指南](https://github.com/khulnasoft/heroui-mcp/blob/main/CONTRIBUTING.md)
