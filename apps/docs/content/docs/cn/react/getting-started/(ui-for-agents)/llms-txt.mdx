---
title: LLMs.txt
description: 让 Claude、Cursor、Windsurf 等 AI 助手理解 PrismUI v3
---

我们提供 [LLMs.txt](https://llmstxt.org/) 文件，让 AI 编码助手可以访问 PrismUI v3 文档。

## 可用文件

**核心文档：**
- [/react/llms.txt](/react/llms.txt) — React 文档的快速参考索引
- [/react/llms-full.txt](/react/llms-full.txt) — 完整的 PrismUI React 文档
...
发现 AI 生成的代码有问题？欢迎在 [GitHub](https://github.com/khulnasoft/prismui) 上帮助我们改进 LLMs.txt 文件。
