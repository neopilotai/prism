...
- **🤖 [PrismUI Chat](https://heroui.chat?ref=heroui-v3)**（文本生成应用） — 用自然语言创建应用
...
- [贡献指南](https://github.com/khulnasoft/heroui/blob/main/CONTRIBUTING.md)

PrismUI 基于 [Apache License 2.0](https://github.com/khulnasoft/heroui/blob/main/LICENSE) 协议发布。
