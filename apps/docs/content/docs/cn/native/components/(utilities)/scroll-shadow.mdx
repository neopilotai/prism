...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/scroll-shadow-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/scoll-shadow-docs-dark.mp4.mp4"
/>
...
更多示例见 [GitHub 仓库](https://github.com/khulnasoft/prismui-native/blob/main/example/src/app/(home)/components/scroll-shadow.tsx)。
