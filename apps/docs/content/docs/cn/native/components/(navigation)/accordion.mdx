...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/accordion-docs-light.mp4"
  srcDark="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/native/components/videos/accordion-docs-dark-1.mp4"
/>
...
更多示例见 [GitHub 仓库](https://github.com/khulnasoft/prism/blob/main/example/src/app/(home)/components/accordion.tsx)。
