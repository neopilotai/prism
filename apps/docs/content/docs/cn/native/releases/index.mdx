...
🎉 全新的 CLI，用于一键创建 PrismUI Native 项目。`npx create-heroui-native-app@latest my-app` 即可生成一个完整的 Expo Router 应用，内置 PrismUI Native、Uniwind、Tailwind CSS、所有必需的 peer 依赖以及 Provider 包装 —— 还可在单页面与 Tabs 两套起始模板中任选其一。
...
发现问题或想参与贡献？请访问我们的 [GitHub 仓库](https://github.com/khulnasoft/heroui-native)。
