...
**相关 PR：** [#174](https://github.com/khulnasoft/heroui-native/pull/174)
...
**相关 PR：** [#182](https://github.com/khulnasoft/heroui-native/pull/182)
...
**相关 PR：** [#176](https://github.com/khulnasoft/heroui-native/pull/176)
...
**相关 PR：** [#170](https://github.com/khulnasoft/heroui-native/pull/170)
...
**相关 PR：** [#179](https://github.com/khulnasoft/heroui-native/pull/179)

## 问题修复

本版本包含以下修复：

- **[Issue #173](https://github.com/khulnasoft/heroui-native/issues/173)**：修复 `classNames={{ container: "bg-x" }}` 无法为 TextField.Input 容器设置 `backgroundColor` 的问题。
- **[Issue #177](https://github.com/khulnasoft/heroui-native/issues/177)**：修复按钮缩放动画有时停留在 0.9 倍、松手后无法回弹的问题。
- **[Issue #178](https://github.com/khulnasoft/heroui-native/issues/178)**：修复影响组件功能的问题。
