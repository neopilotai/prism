---
title: 动画
description: 为 PrismUI Native 组件添加流畅动画与过渡
icon: copy-transparent
---

PrismUI Native 的动画基于 [react-native-reanimated](https://docs.swmansion.com/react-native-reanimated/)，手势由 [react-native-gesture-handler](https://docs.swmansion.com/react-native-gesture-handler/) 处理。若需更细粒度控制，建议先熟悉二者。
...
在 `PrismUINativeProvider` 上统一关闭应用内全部 PrismUI Native 动画：
