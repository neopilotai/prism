...
完整参考：[颜色文档](/docs/native/getting-started/colors)、[默认主题变量](https://github.com/khulnasoft/prism/blob/main/src/styles/variables.css)、[共享主题工具](https://github.com/khulnasoft/prism/blob/main/src/styles/theme.css)

**计算变量（Tailwind）：**

我们通过 Tailwind 的 `@theme` 指令自动生成按压态与圆角等计算变量，定义见 [theme.css](https://github.com/khulnasoft/prism/blob/main/src/styles/theme.css)：
