...
当前 MCP 服务器支持 **heroui-native** 与 [stdio 传输](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio)。npm 包名为 `@khulnasoft/native-mcp`。源码见 [GitHub](https://github.com/heroui-inc/heroui-mcp)。
