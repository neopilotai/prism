...
The [PrismUI Figma Kit (v3)](https://www.figma.com/community/file/1546526812159103429/heroui-figma-kit-v3) keeps design and code in sync. Components in Figma match the React implementation, so designers and developers work from the same source of truth.
...
- [GitHub](https://github.com/khulnasoft/heroui) — Source code, issues, and discussions
...
- [GitHub Repository](https://github.com/khulnasoft/heroui) — Source code and issues
