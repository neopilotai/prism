...
**HeroUI** is a traditional component library. You install `@khulnasoft/react`, import components, and use them. Updates come through npm. The library team maintains the components, fixes bugs, and adds features. You customize through props, slots, and Tailwind classes.
...
**HeroUI:** Run `npm update @khulnasoft/react`. All components update together. Breaking changes are documented in release notes.
