...
[PrismUI Pro](https://heroui.com/pro) offers pre-built dashboard templates designed specifically for SaaS products, admin panels, and analytics dashboards. Built on PrismUI v3 components with Tailwind CSS v4.
...
If you want a PrismUI-native dashboard, start with [PrismUI Pro](https://heroui.com/pro) rather than rebuilding the frame from base components. Use the Pro dashboard template for the app shell and add product-specific widgets only where your product needs something unique.
...
- [PrismUI Pro](https://heroui.com/pro) — Pre-built dashboard templates and premium components
