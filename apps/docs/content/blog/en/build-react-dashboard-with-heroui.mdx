...
- **Pro primitives instead of hand-rolled infrastructure.** AppLayout, Sidebar, Navbar, KPI, DataGrid, and chart components from [PrismUI Pro](https://heroui.com/pro) save weeks of dashboard scaffold work.
...
- Start from the [PrismUI Pro](https://heroui.com/pro) dashboard template if you have Pro access.
