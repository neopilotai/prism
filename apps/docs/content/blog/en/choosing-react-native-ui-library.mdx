...
description: "A practical framework for choosing a React Native UI library, and where PrismUI Native fits."
date: "2026-05-12"
...
This guide explains how we think about that decision, and why PrismUI Native is built the way it is.
...
PrismUI Native takes the package approach:

- Install `prismui-native`.
...
PrismUI Native is intentionally opinionated about the baseline:
...
PrismUI Native is strongest when you want one ecosystem across product surfaces:

- Web product: [PrismUI React](/docs/react/getting-started/quick-start)
- Mobile product: [PrismUI Native](/docs/native/getting-started)
- Premium app surfaces: [PrismUI Pro](https://prism.khulnasoft.com/pro)
- Design handoff: [PrismUI Figma Kit V3](https://www.figma.com/community/file/1546526812159103429/prismui-figma-kit-v3)
...
## Where PrismUI Native Is Different

PrismUI Native is built specifically for React Native. It does not ask you to use web imports or CSS files that do not belong in mobile apps.
...
Do not use the PrismUI web package or web-only event handlers in React Native screens.

PrismUI Native uses `onPress`, `PrismUINativeProvider`, `GestureHandlerRootView`, Uniwind, and native overlay/portal patterns because those are the right abstractions for mobile.

## Recommendation

Choose PrismUI Native when your team values design quality, maintainability, and ecosystem leverage. It is especially compelling if you already use PrismUI on the web, work from Figma, or build with AI coding assistants.
