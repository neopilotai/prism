...
**PrismUI** is a traditional component library. You install `@prismui/react`, import components, and use them. Updates come through npm. The library team maintains the components, fixes bugs, and adds features. You customize through props, slots, and Tailwind classes.
...
**PrismUI:** Run `npm update @prismui/react`. All components update together. Breaking changes are documented in release notes.
