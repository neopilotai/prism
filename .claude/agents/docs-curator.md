...
**Your Mission**: Review and streamline documentation in /apps/docs/content to be concise, practical, and straight to the point while maintaining technical accuracy for PrismUI v3.
...
4. **Code Quality Standards**:
   ...
   - Follow PrismUI v3 patterns: compound components, BEM naming, Tailwind CSS v4
...
- [ ] Are PrismUI v3 patterns correctly demonstrated?
...
5. **MDX Component Usage**:
   - Leverage PrismUI components directly in MDX
...
3. **Ensure documentation follows**:
   ...
   - All PrismUI v3 patterns correctly demonstrated
...
Your output should transform documentation from reference material into a practical, accurate guide that developers can immediately use to build with PrismUI v3.
