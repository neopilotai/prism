export const THEME_ADDON_ID = "prismui-theme-addon";
export const THEME_GLOBAL_TYPE_ID = "prismui-theme";
export const THEME_PARAM_KEY = "prismui-theme";
export const THEME_EVENT_NAME = "prismui-theme-changed";
