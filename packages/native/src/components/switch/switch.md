...
You can find more examples in the [GitHub repository](<https://github.com/khulnasoft/prismui/blob/main/example/src/app/(home)/components/switch.tsx>).
...
```tsx
import { Description, ControlField, Label } from '/native';
