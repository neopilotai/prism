...
You can find more examples in the [GitHub repository](<https://github.com/khulnasoft/prismui/blob/main/example/src/app/(home)/components/select.tsx>).
...
```tsx
import { useSelectAnimation } from '/native';
...
```tsx
import { useSelectItem } from '/native';
