...
You can find more examples in the [GitHub repository](<https://github.com/khulnasoft/prismui/blob/main/example/src/app/(home)/components/text-field.tsx>).
...
```tsx
import { TextField, useTextField } from '/native';
