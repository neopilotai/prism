...
PrismUI Native's color system is built on top of [Tailwind CSS v4](https://tailwindcss.com/docs/theme)'s theme via [Uniwind](https://uniwind.dev/). When you import `/native/styles`, it uses Tailwind's built-in color palettes and maps them to semantic variables.
