...
const users = [
  {
    id: 1,
    image_url: "https://img.prismui.chat/image/avatar?w=400&h=400&u=3",
    name: "John",
  },
  {
    id: 2,
    image_url: "https://img.prismui.chat/image/avatar?w=400&h=400&u=5",
    name: "Kate",
  },
  {
    id: 3,
    image_url: "https://img.prismui.chat/image/avatar?w=400&h=400&u=20",
    name: "Emily",
  },
  {
    id: 4,
    image_url: "https://img.prismui.chat/image/avatar?w=400&h=400&u=23",
    name: "Michael",
  },
  {
    id: 5,
    image_url: "https://img.prismui.chat/image/avatar?w=400&h=400&u=16",
    name: "Olivia",
  },
];
...
const circles = [
  {
    id: 1,
    image_url: "https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/red.jpg",
    name: "R",
  },
  {
    id: 2,
    image_url: "https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/orange.jpg",
    name: "O",
  },
  {
    id: 3,
    image_url: "https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/green.jpg",
    name: "G",
  },
  {
    id: 4,
    image_url: "https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/white.jpg",
    name: "W",
  },
  {
    id: 5,
    image_url: "https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/black.jpg",
    name: "B",
  },
];
...
const Template = ({color, size}: Avatar["RootProps"]) => (
  <div className="flex items-start gap-4">
    ...
    <div className="flex flex-col gap-4">
      <Avatar color={color} size={size}>
        <Avatar.Image alt="John Doe" src="https://img.prismui.chat/image/avatar?w=400&h=400&u=3" />
        <Avatar.Fallback delayMs={600}>JD</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image
          alt="Junior Garcia"
          src="https://img.prismui.chat/image/avatar?w=400&h=400&u=4"
        />
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Paul" src="https://img.prismui.chat/image/avatar?w=400&h=400&u=8" />
    ...
    <div className="flex flex-col gap-4">
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image
          alt="Orange"
          src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/orange.jpg"
        />
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image
          alt="White"
          src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/white.jpg"
        />
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image
          alt="Black"
          src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/black.jpg"
        />
...
const TemplateWithDelay = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      <Avatar color={color} size={size}>
        <Avatar.Image
          src={`https://app.requestly.io/delay/${delay}/https://img.prismui.chat/image/avatar?w=400&h=400&u=3`}
        />
      </Avatar>
    </div>
  );
...
export const Sizes = {
  render: () => (
    <div className="flex items-center gap-4">
      <Avatar size="sm">
        <Avatar.Image alt="Small" src="https://img.prismui.chat/image/avatar?w=400&h=400&u=3" />
        <Avatar.Fallback>SM</Avatar.Fallback>
      </Avatar>
      <Avatar size="md">
        <Avatar.Image alt="Medium" src="https://img.prismui.chat/image/avatar?w=400&h=400&u=4" />
        <Avatar.Fallback>MD</Avatar.Fallback>
      </Avatar>
      <Avatar size="lg">
        <Avatar.Image alt="Large" src="https://img.prismui.chat/image/avatar?w=400&h=400&u=5" />
  ...
  const variants = [
    ...
    {label: "icon soft", type: "icon-soft", content: <Icon icon="gravity-ui:person" />},
    {
      ...
      content: [
        ...
        "https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/black.jpg",
