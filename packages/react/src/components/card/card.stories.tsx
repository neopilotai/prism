  ...
  render: (args) => (
    <Card className="w-full items-stretch md:flex-row" {...args}>
      <img
        ...
        loading="lazy"
        src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/components/card/porsche-911.png"
      />
        ...
        <div className="col-span-12 grid grid-cols-12 gap-4">
          ...
          <Card className="col-span-12 min-h-[200px] rounded-3xl lg:col-span-6" {...args}>
            ...
            <img
              ...
              src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/neo2.jpeg"
            />
        ...
        <div className="col-span-12 grid grid-cols-12 gap-4">
          ...
          >
            <img
              ...
              aria-hidden="true"
              className="absolute inset-0 h-full w-full object-cover"
              src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/neo1.jpeg"
            />
          ...
          <div className="col-span-12 flex flex-col gap-2 md:col-span-4 md:justify-between md:gap-0">
            ...
            <Card className="flex flex-row gap-3 p-1" variant="transparent">
              <img
                ...
                loading="lazy"
                src="https://prismui-assets.nyc3.cdn.digitaloceanspaces.com/docs/robot1.jpeg"
              />
