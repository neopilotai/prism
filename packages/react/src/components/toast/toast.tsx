...
import type {ToastVariants} from "@khulnasoft/styles";
...
import {toastVariants} from "@khulnasoft/styles";
import React, {
  createContext,
  use,
  useCallback,
...
Toast.displayName = "PrismUI.Toast";
...
ToastIndicator.displayName = "PrismUI.ToastIndicator";
...
ToastTitle.displayName = "PrismUI.ToastTitle";
...
ToastDescription.displayName = "PrismUI.ToastDescription";
...
ToastCloseButton.displayName = "PrismUI.ToastCloseButton";
...
ToastActionButton.displayName = "PrismUI.ToastActionButton";
...
const ToastProvider = <T extends object = ToastContentValue>({
  ...
  const toastQueue = useMemo((): StatelyToastQueue<T> => {
    if (queueProp) {
      // Region consumes the underlying react-stately queue, not the PrismUI wrapper.
...
ToastProvider.displayName = "PrismUI.ToastProvider";
