...
import type {PrismUIToastOptions} from "./toast-queue";
...
interface ToastStoryProps extends Omit<PrismUIToastOptions, "variant"> {
  placement?: Placement;
}
        ...
        <Button
          ...
          onPress={() => {
            toast("You have been invited to join a team", {
              ...
              description: "Bob sent you an invitation to join PrismUI team",
