...
${componentName}.displayName = "PrismUI.${componentName}";
`;
...
`;
  ...
  console.log(`      - import { ${componentName} } from "@khulnasoft/react"`);
  console.log(`      - import { ${componentName} } from "@khulnasoft/react/${kebabName}"`);
}
