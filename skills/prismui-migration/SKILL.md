...
# PrismUI v2 to v3 Migration Guide

This skill helps agents migrate PrismUI v2 applications to v3. PrismUI v3 introduces breaking changes: compound components, no Provider, Tailwind v4, and removed hooks.
...
3. **No Provider**: Remove `PrismUIProvider` when migrating
...
2. Analyze project (PrismUI imports, component usage)
