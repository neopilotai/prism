#!/usr/bin/env node
/**
 * Get non-component PrismUI Native documentation (guides, theming, releases).
 *
 * Usage:
...
/**
 * Fetch documentation from PrismUI Native API.
...
async function fetchApi(path) {
  ...
  try {
    const response = await fetch(url, {
      headers: {"User-Agent": "PrismUI-Native-Skill/1.0"},
