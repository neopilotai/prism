#!/usr/bin/env node
/**
 * Get the main migration workflow guide (full or incremental) for PrismUI v2 to v3.
 *
 * Usage:
...
async function fetchDoc(filename) {
  ...
  try {
    const response = await fetch(url, {
      headers: {"User-Agent": "PrismUI-Migration-Skill/1.0"},
  ...
  try {
    ...
    const title =
      migrationType === "incremental"
        ? "PrismUI v2 to v3 Agent Migration Guide - Incremental Migration"
        : "PrismUI v2 to v3 Agent Migration Guide - Full Migration";
